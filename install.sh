...
run_postinst() {
  ...
  for f in Xresources curlrc wgetrc gntrc inputrc libao profile rpmmacros xscreensaver \
    config/lynx/lynx.cfg config/lynx/lynx.lss config/xresources config/dunst; do ln_sf "$APPDIR/$f" "$HOME/.$f"; done
